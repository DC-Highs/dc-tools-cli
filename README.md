...
│   █████████████████      ██████╔╝╚██████╗       ██║   ╚██████╔╝╚██████╔╝███████╗███████║    ╚██████╗███████╗██║     │
│      ████████ ████████   ╚═════╝  ╚═════╝       ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝╚══════╝     ╚═════╝╚══════╝╚═╝     │
│           ████████████                                 https://dchighs.vercel.app                                   │
│   ███████████████████                                                                                               │
│                                                                                                                     │
│   by Marcuth from DC HIGHS v0.2.0 • @dchighs/dc-tools-cli                                                           │
│                                                                                                                     │
│   Repo     : https://github.com/DC-Highs/dc-tools-cli                                                               │
│   Releases : https://github.com/DC-Highs/dc-tools-cli/releases                                                      │
│   Issues   : https://github.com/DC-Highs/dc-tools-cli/issues                                                        │
│                                                                                                                     │
╰─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
```
